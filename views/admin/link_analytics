            ...
            <tr>
              <td class="url-cell">
                <a href="{{ $referrer['ref_url'] }}" target="_blank" class="url-link">
                  {{ strlen($referrer['ref_url']) > 50 ? substr($referrer['ref_url'], 0, 50) . '...' :
                  $referrer['ref_url'] }}
                </a>
              </td>
      ...
      <div class="table-container">
        <table class="data-table">
          ...
          <tbody>
            ...
            $referrerDisplay = '<a href="' . $referrerUrl . '" target="_blank" class="url-link">' .
              (strlen($referrerUrl) > 30 ? substr($referrerUrl, 0, 30) . '...' : $referrerUrl) . '</a>';
            }
            @endphp
            <tr>
