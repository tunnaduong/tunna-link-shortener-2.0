        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <textarea id="link_excerpt" name="link_excerpt" rows="3"
              placeholder="Brief description of the link">{{ $_POST['link_excerpt'] ?? '' }}</textarea>
          </div>
    ...
    <div class="batch-shorten-container">
      ...
      <div class="batch-format-info">
        ...
        <ul>
          ...
          <li><strong>With Custom Code:</strong> <code>https://example.com|myshortcode|type|wait|password|tag</code></li>
        </ul>
        <p><strong>Parameters:</strong> custom_code (optional), type (0=direct, 1=click, 2=captcha, 3=password), wait (seconds), password, tag</p>
      </div>
