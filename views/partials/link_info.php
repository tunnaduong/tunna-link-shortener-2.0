...
<table class="table" style="margin-bottom: 20px;">
  <tbody>
    <tr>
      <td>ID</td>
      <td><?= htmlspecialchars($link->getCode()) ?></td>
    </tr>
    <tr>
      <td>Tiêu đề</td>
      <td><?= htmlspecialchars($link->getLinkTitle() ?: 'N/A') ?></td>
    </tr>
    <tr>
      <td>Mô tả</td>
      <td><?= htmlspecialchars($link->getLinkExcerpt() ?: 'N/A') ?></td>
    </tr>
    <tr>
      <td>Mật khẩu</td>
      <td><?= htmlspecialchars($passwordInfo) ?></td>
    </tr>
    <tr>
      <td>Lượt truy cập</td>
      <td><?= $visit_count ?></td>
